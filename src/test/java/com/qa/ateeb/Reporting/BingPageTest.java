...
public class BingPageTest {
	...
	public static void initial() {
		...
		report = new ExtentReports("C:\\Users\\Admin\\Desktop\\My Eclipse Workspace\\Reporting\\Reports\\Report.html", true);
	...
	public void bingSearchBox() throws InterruptedException {
		...
		if (searchPage.getHeading().getText().equals("Selenium")) {
